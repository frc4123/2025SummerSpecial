...
public class Vision extends SubsystemBase {
    ...
    private Rotation2d calculateGamePieceAngle(int tagId) {
        ...
        switch(tagId) {
            ...
            case 12: return Rotation2d.fromDegrees(55 + blueInversionFactor);
            case 1: return Rotation2d.fromDegrees(305 + redInversionFactor);
            case 2: return Rotation2d.fromDegrees(55 + redInversionFactor);
