...
public class AutoLineUpAlgae extends SequentialCommandGroup {

    private CommandSwerveDrivetrain swerve;

    public AutoLineUpAlgae(CommandSwerveDrivetrain swerve) {
        this.swerve = swerve;
    ...
    public Pose2d addRobotCentrictoFieldCentric(Pose2d robotPose, boolean isRedAlliance) {
        double xOffset = Constants.AutoDriveConstants.ALGAEADDITIONS[0];
        double yOffset = Constants.AutoDriveConstants.ALGAEADDITIONS[1];
